...
export const WeatherIcon = ({icon, className = '', as = 'image', priority = false }: WeatherIconProps) => {

  return (
    <div className={cn('relative w-24 h-24', className)}>
      <Image
        src={as === 'image' ? weatherImages[icon] : `https://openweathermap.org/img/wn/${icon}.png`}
        alt="j"
        fill
